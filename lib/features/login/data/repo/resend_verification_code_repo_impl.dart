...
class ResendVerificationCodeRepoImpl implements BaseResendVerificationCodeRepo {
  final BaseResendVerificationCodeRemoteDataSource baseResendVerificationCodeRemoteDataSource;

  ResendVerificationCodeRepoImpl(this.baseResendVerificationCodeRemoteDataSource);

  @override
  Future<Either<Failure, ResendVerificationCodeModel>> resendVerificationCode({
    required String userId,
  }) async {
    return await baseResendVerificationCodeRemoteDataSource.resendVerificationCode(
      userId: userId,
    );
  }
}
