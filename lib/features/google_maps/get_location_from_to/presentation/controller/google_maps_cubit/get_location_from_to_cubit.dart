...
part 'get_location_from_to_state.dart';

class GetLocationFromToCubit extends Cubit<GetLocationFromToState> {
  ...
  Future<void> getUserLocation() async {
    try {
      ...
      emit(GetLocationFromToSuccessState());
    } catch (e) {
      emit(GetLocationFromToErrorState(e.toString()));
    }
  }
